...
import '../../controller/customer_recording_provider.dart';

class CustomerRecordingScreen extends StatelessWidget {
  const CustomerRecordingScreen({super.key,required this.productLocation});

  final String productLocation;
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<CustomerCameraProvider>(
      create: (_) => CustomerCameraProvider()..init(context),
      child: Consumer<CustomerCameraProvider>(
                          ...
                          Column(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () {
                                  context.pushNamed(
                                    RouteName.customerPreviewScreen,
                                    extra: {
